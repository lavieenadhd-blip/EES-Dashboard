...
with st.expander("⚠️ Econometric Boundaries & Framework Limitations"):
    ...
    * **Latent Construct Overlap:** Because underlying sub-indicators of the EES framework (such as healthcare insulation and poverty mitigation) operate as known downstream determinants of macro health profiles, the model relies on shared latent capability pathways. Output should not be interpreted as absolute clean causal discovery.
    """)
